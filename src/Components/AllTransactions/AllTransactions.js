...
const AllTransactions = ({ setAllTransactions }) => {
  ...
  return (
    <div className="w-[92.5%] flex flex-col items-center justify-start h-[110%] bg-[#121826] absolute top-20 left-[3.75%] rounded-t-3xl px-6 py-8 pt-4 opacity-[97.5%] text-white gap-4 bottom-0">
